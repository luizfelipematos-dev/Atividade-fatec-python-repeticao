...
Receba um número. Calcule e mostre a série:
...
Obtenha 2 números inteiros, verifique qual o maior entre eles. Calcule e mostre o resultado da somatória dos números ímpares entre esses valores.

### Exercício 06

Receba um número N. Calcule e mostre a série:
...
Calcule a quantidade de grãos contidos em um tabuleiro de xadrez, considerando:
...
Obtenha 2 números inteiros. Verifique e mostre todos os números primos existentes entre eles.
...
* Maria tem 1,50 m e cresce 2 cm ao ano.
